...
echo ========================================
echo   EtaMusic Web - Environment Setup
echo ========================================
echo.
...
if exist "%~dp0web\backend\venv\Scripts\python.exe" (
    echo [INFO] venv already exists: %~dp0web\backend\venv\Scripts\python.exe
...
echo ========================================
echo venv path: %~dp0web\backend\venv
echo You can now run start.bat to launch the web service
echo.
pause