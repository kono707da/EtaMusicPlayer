<script setup>
const { ref, onMounted } = window.__etamusic.vue
const { useRouter } = window.__etamusic.vueRouter
const { Button, Input, Label, Badge, useToast } = window.__etamusic.ui
const { User, LogOut, Loader2, Heart, Star } = window.__etamusic.icons
