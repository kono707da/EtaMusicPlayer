<script setup>
const { ref, computed, onMounted, onUnmounted } = window.__etamusic.vue
const { useRouter } = window.__etamusic.vueRouter
const { Button, Badge, Empty, useToast, CoverPickerDialog } = window.__etamusic.ui
const {
  ArrowLeft, RefreshCw, Loader2, CheckCircle2, AlertCircle,
  Clock, XCircle, Trash2, Ban, Download, ImageIcon
} = window.__etamusic.icons
import { listDownloads, getDownload, cancelDownload, deleteDownload, applyCover, coverUrl } from '../api'
