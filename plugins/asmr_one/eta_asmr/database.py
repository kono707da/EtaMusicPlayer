...
DB_PATH = Path(__file__).resolve().parent.parent.parent.parent / "data" / "asmr_one.db"
...
def init_db() -> None:
    from eta_asmr.models import DownloadFileStatus, DownloadTask, Setting  # noqa: F401
