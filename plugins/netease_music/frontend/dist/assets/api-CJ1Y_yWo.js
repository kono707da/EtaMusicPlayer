...
(t.charCodeAt(2) > 122 || t.charCodeAt(2) < 97), Te = (t) => t.startsWith("onUpdate:"), H = Object.assign, $e = Object.prototype.hasOwnProperty, Rt = (t, e) => $e.call(t, e), h = Array.isArray, z = (t) => ft(t) === "[object Map]", Ce = (t) => ft(t) === "[object Set]", P = (t) => typeof t == "function", O = (t) => typeof t == "string", k = (t) => typeof t == "symbol", _ = (t) => t !== null && typeof t == "object", qt = Object.prototype.toString, ft = (t) => qt.call(t), Yt = (t) => ft(t).slice(8, -1), De = (t) => ft(t) === "[object Object]", Dt = (t) => O(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t, Jt = (t) => {
  const e = /* @__PURE__ */ Object.create(null);
...
const Gt = (t) => !!(t && t.__v_isRef === !0), He = (t) => O(t) ? t : t == null ? "" : h(t) || _(t) && (t.toString === qt || !P(t.toString)) ? Gt(t) ? He(t.value) : JSON.stringify(t, Qt, 2) : String(t), Qt = (t, e) => Gt(e) ? Qt(t, e.value) : z(e) ? {
...
function U(t) {
  ...
  return e === t ? e : (g(e, "iterate", X), /* @__PURE__ */ S(t) ? e : e.map(C));
}
function _t(t) {
  return g(t = /* @__PURE__ */ p(t), "iterate", X), t;
}
function V(t, e) {
  return /* @__PURE__ */ v(t) ? J(/* @__PURE__ */ gt(t) ? C(e) : e) : C(e);
}
const Le = {
  __proto__: null,
  [Symbol.iterator]() {
...
function wt(t, e, n) {
  const s = _t(t), r = s[e]();
  return s !== t && !/* @__PURE__ */ S(t) && (r._next = r.next, r.next = () => {
    const o = r._next();
...
function I(t, e, n, s, r, o) {
  const c = _t(t), i = c !== t && !/* @__PURE__ */ S(t), a = c[e];
  if (a !== We[e]) {
    const l = a.apply(t, o);
    return i ? C(l) : l;
  }
...
function kt(t, e, n, s) {
  const r = _t(t), o = r !== t && !/* @__PURE__ */ S(t);
  let c = n, i = !1;
...
class ee {
  ...
  get(e, n, s) {
    ...
    return _(i) ? r ? /* @__PURE__ */ xt(i) : /* @__PURE__ */ se(i) : i;
  }
}
class qe extends ee {
  constructor(e = !1) {
  ...
  set(e, n, s, r) {
    ...
    if (!this._isShallow) {
      ...
      if (!/* @__PURE__ */ S(s) && !/* @__PURE__ */ v(s) && (o = /* @__PURE__ */ p(o), s = /* @__PURE__ */ p(s)), !c && /* @__PURE__ */ $(o) && !/* @__PURE__ */ $(s))
...
function Qe(t, e, n) {
  return function(...s) {
    const r = this.__v_raw, o = /* @__PURE__ */ p(r), c = z(o), i = t === "entries" || t === Symbol.iterator && c, a = t === "keys" && c, u = r[t](...s), f = n ? It : e ? J : C;
    return !e && g(
      o,
      "iterate",
      a ? vt : F
...
function Ze(t, e) {
  const n = {
    ...
    forEach(r, o) {
      const c = this, i = c.__v_raw, a = /* @__PURE__ */ p(i), u = e ? It : t ? J : C;
  ...
  return H(
    ...
    t ? {
      ...
      add(r) {
        const o = /* @__PURE__ */ p(this), c = nt(o), i = /* @__PURE__ */ p(r), a = !e && !/* @__PURE__ */ S(r) && !/* @__PURE__ */ v(r) ? i : r;
        return c.has.call(o, a) || L(r, a) && c.has.call(o, r) || L(i, a) && c.has.call(o, i) || (o.add(a), A(o, "add", a, a)), this;
      },
      set(r, o) {
        !e && !/* @__PURE__ */ S(o) && !/* @__PURE__ */ v(o) && (o = /* @__PURE__ */ p(o));
...
const C = (t) => _(t) ? /* @__PURE__ */ se(t) : t, J = (t) => _(t) ? /* @__PURE__ */ xt(t) : t;
// @__NO_SIDE_EFFECTS__
function $(t) {
  return t ? t.__v_isRef === !0 : !1;
}
function Wn(t) {
  return /* @__PURE__ */ $(t) ? t.value : t;
}
/**
...
function ce(t, e, n) {
  return O(e) ? (e = JSON.stringify(e), n ? e : [`${t}=${e}`]) : typeof e == "number" || typeof e == "boolean" || e == null ? n ? e : [`${t}=${e}`] : /* @__PURE__ */ $(e) ? (e = ce(t, /* @__PURE__ */ p(e.value), !0), n ? e : [`${t}=Ref<`, e, ">"]) : P(e) ? [`${t}=fn${e.name ? `<${e.name}>` : ""}`] : (e = /* @__PURE__ */ p(e), n ? e : [`${t}=`, e]);
}
const ae = {
...
const pn = 100;
function hn(t) {
  let e = x + 1, n = E.length;
  for (; e < n; ) {
    const s = e + n >>> 1, r = E[s], o = tt(r);
...
function _n(t) {
  if (!(t.flags & 1)) {
    const e = tt(t), n = E[E.length - 1];
    !n || // fast path when the job id is larger than the tail
    !(t.flags & 2) && e >= tt(n) ? E.push(t) : E.splice(hn(e), 0, t), t.flags |= 1, ue();
  }
}
function ue() {
  Tt || (Tt = dn.then(fe));
...
function fe(t) {
  ...
  try {
    ...
    x = -1, E.length = 0, mn(t), Tt = null, (E.length || B.length) && fe(t);
  }
}
function de(t, e) {
  const n = t.get(e) || 0;
...
let M, Z = [], $t = !1;
function bn(t, ...e) {
  M ? M.emit(t, ...e) : $t || Z.push({ event: t, args: e });
}
function pe(t, e) {
  var n, s;
  ...
  !((s = (n = window.navigator) == null ? void 0 : n.userAgent) != null && s.includes("jsdom")) ? ((e.__VUE_DEVTOOLS_HOOK_REPLAY__ = e.__VUE_DEVTOOLS_HOOK_REPLAY__ || []).push((o) => {
    ...
    M || (e.__VUE_DEVTOOLS_HOOK_REPLAY__ = null, $t = !0, Z = []);
  }, 3e3)) : ($t = !0, Z = []);
}
...
function Wt(t) {
  const e = T;
  return T = t, he = t && t.type.__scopeId || null, e;
}
function zn(t, e = T, n) {
  if (!e || t._n)
    return t;
...
function Bn(t, e, n, s) {
  ...
  if (c || O(t)) {
    ...
    let a = !1, u = !1;
    i && (a = !/* @__PURE__ */ S(t), u = /* @__PURE__ */ v(t), t = _t(t)), r = new Array(t.length);
    for (let f = 0, l = t.length; f < l; f++)
      r[f] = e(
        a ? u ? J(C(t[f])) : C(t[f]) : t[f],
        f,
        void 0,
        o
      );
...
const vn = {}, ge = (t) => Object.getPrototypeOf(t) === vn, In = (t) => t.__isSuspense, me = /* @__PURE__ */ Symbol.for("v-fgt"), xn = /* @__PURE__ */ Symbol.for("v-txt"), Ct = /* @__PURE__ */ Symbol.for("v-cmt"), q = [];
let m = null;
function Tn(t = !1) {
  q.push(m = t ? null : []);
}
...
const Dn = (...t) => Ne(
  ...
  ref_key: e,
  ref_for: n
}) => (typeof t == "number" && (t = "" + t), t != null ? O(t) || /* @__PURE__ */ $(t) || P(t) ? { i: T, r: t, k: e, f: !!n } : t : null);
function be(t, e = null, n = null, s = 0, r = null, o = t === me ? 0 : 1, c = !1, i = !1) {
  ...
  return i ? (ut(a, n), o & 128 && t.normalize(a)) : n && (a.shapeFlag |= O(n) ? 8 : 16), process.env.NODE_ENV !== "production" && a.key !== a.key && K("VNode created with invalid key (NaN). VNode type:", a.type), et > 0 && // avoid a block node from tracking itself
...
function Ne(t, e = null, n = null, s = 0, r = null, o = !1) {
  if ((!t || t === Rn) && (process.env.NODE_ENV !== "production" && !t && K(`Invalid vnode type when creating vnode: ${t}.`), t = Ct), Cn(t)) {
    const i = lt(
      t,
      e,
      !0
  ...
  if (Ve(t) && (t = t.__vccOpts), e) {
    ...
    i && !O(i) && (e.class = Mt(i)), _(a) && (/* @__PURE__ */ it(a) && !h(a) && (a = H({}, a)), e.style = At(a));
  }
  const c = O(t) ? 1 : In(t) ? 128 : On(t) ? 64 : _(t) ? 4 : P(t) ? 2 : 0;
...
function Mn(t = " ", e = 0) {
  return Kt(xn, null, t, e);
}
function Yn(t = "", e = !1) {
  return e ? (Tn(), $n(Ct, null, t)) : Kt(Ct, null, t);
}
function ut(t, e) {
  let n = 0;
  const { shapeFlag: s } = t;
  if (e == null)
    ...
    if (s & 65) {
      ...
      n = 32;
      const r = e._;
      !r && !ge(e) ? e._ctx = T : r === 3 && T && (T.slots._ === 1 ? e._ = 1 : (e._ = 2, t.patchFlag |= 1024));
    }
  else if (P(e)) {
    if (s & 65) {
      ut(t, { default: e });
...
function Kn() {
      ...
      if (/* @__PURE__ */ $(l)) {
        ...
        if (/* @__PURE__ */ gt(l))
          return [
            "div",
            {},
            ["span", t, /* @__PURE__ */ S(l) ? "ShallowReactive" : "Reactive"],
            "<",
            i(l),
        ...
        if (/* @__PURE__ */ v(l))
          return [
            "div",
            {},
            ["span", t, /* @__PURE__ */ S(l) ? "ShallowReadonly" : "Readonly"],
            "<",
            i(l),
            ">"
          ];
  ...
  function o(l) {
    ...
    const w = a(l, "computed");
    w && d.push(c("computed", w));
    const R = a(l, "inject");
  ...
  function u(l, d, w) {
    const R = l[w];
    if (h(R) && R.includes(d) || _(R) && d in R || l.extends && u(l.extends, d, w) || l.mixins && l.mixins.some((G) => u(G, d, w)))
      return !0;
  }
  function f(l) {
...
const kn = window.__etamusic.axios, b = kn.create({ baseURL: "", timeout: 3e4 }), y = "/api/netease";
function N(t, e = "") {
  var r, o;
...
async function Gn() {
  try {
    return (await b.get(`${y}/accounts`)).data;
  } catch (t) {
    N(t, "获取账号列表失败");
  }
}
async function Qn(t) {
  try {
    return (await b.post(`${y}/accounts/switch`, null, { params: { ncm_uid: t } })).data;
  } catch (e) {
    N(e, "切换账号失败");
  }
}
async function Zn(t) {
  try {
    return (await b.delete(`${y}/accounts/${t}`)).data;
  } catch (e) {
    N(e, "删除账号失败");
  }
}
async function Xn() {
  try {
    return (await b.get(`${y}/login/qrcode/key`)).data;
  } catch (t) {
    N(t, "获取二维码 key 失败");
  }
}
async function tr(t) {
  return `${y}/login/qrcode/image?unikey=${encodeURIComponent(t)}&_t=${Date.now()}`;
}
async function er(t) {
  try {
    return (await b.get(`${y}/login/qrcode/poll`, { params: { unikey: t } })).data;
  } catch (e) {
    N(e, "查询扫码状态失败");
  }
}
async function nr() {
  try {
    return (await b.post(`${y}/login/refresh`)).data;
  } catch (t) {
    N(t, "刷新登录状态失败");
  }
}
async function rr(t, e = 1, n = 30, s = 0) {
  try {
    return (await b.get(`${y}/search`, { params: { keyword: t, type: e, limit: n, offset: s } })).data;
  } catch (r) {
    N(r, "搜索失败");
  }
}
async function or() {
  try {
    return (await b.get(`${y}/search/hot`)).data;
  } catch (t) {
    N(t, "获取热搜失败");
  }
}
async function Un(t, e = "standard") {
  try {
    ...
    return (await b.get(`${y}/song/url`, { params: { ids: n, level: e } })).data;
  } catch (n) {
    N(n, "获取播放 URL 失败");
  }
}
async function sr(t) {
  try {
    return (await b.get(`${y}/playlist/detail`, { params: { id: t } })).data;
  } catch (e) {
    N(e, "获取歌单详情失败");
  }
}
async function ir() {
  try {
    return (await b.get(`${y}/user/self/playlists`)).data;
  } catch (t) {
    N(t, "获取我的歌单失败");
  }
}
...
async function ar(t, e = {}) {
  try {
    return (await b.post(`${y}/download/songs`, {
      song_ids: t,
      level: e.level || "exhigh",
      target_base_url: e.target_base_url || "local_node",
      target_watch_dir_id: e.target_watch_dir_id || 1,
      target_subdir: e.target_subdir || null
    }, { timeout: 3e4 })).data;
  } catch (n) {
    N(n, "创建下载任务失败");
  }
